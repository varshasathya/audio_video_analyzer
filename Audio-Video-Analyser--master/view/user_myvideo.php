                             ...
                             echo '<div class="col-sm-6">
                                 <div class="jumbotron" style=" background-color:black;padding-top: 10px;padding-right: 0px;padding-left: 0px;padding-bottom: 0px;margin-bottom: 0px;" >
                                     <video src="http://www.trendsepc.in/sih2018/public/video/'.$row["name"].'" alt="User Video"></video>
                                        ...
                                        <button type="submit"  class="btn btn-link " align="left" > <span '; 
                                        ...
                                        <button type="submit"  class="btn btn-link" style="float: right;color:white" > '; 
                                        
                                         $sql="select * from visited_table where dataid={$row['dataid']}";
                                        // echo $sql;
                                        $res=query_dml($conn,$sql);
                                        $row1 = mysqli_fetch_assoc($res);
                                        if($row1["visited"]==0){echo 'Unvisited <span style="color:gold;" class="glyphicon glyphicon-eye-close" >';}
                                        else {echo 'Visited <span style="color:#74edc8;" class="glyphicon glyphicon-eye-open">';}
                                        echo '</span>
