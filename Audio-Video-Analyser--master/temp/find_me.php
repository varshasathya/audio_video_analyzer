                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                                <form action="" method="post" align="center" class="form-horizontal">
                                    <input type="text" name="searchkey" placeholder="Enter the Keyword to search" class="form-control"/><br/>
                                    <button type="submit" class="btn btn-info">Search Keyword</button>
                                </form>
                            </div>
                        <div class="col-md-2">
                            </div>
