         ...
         <div class="row">
            <div class="col-sm-8 sscroll" style="background-color:lavender;">
               <div class="row" id="video">
                  <video style="height:550px;width:95%;" id="myVideo" controls>
                     <source src="http://trendsepc.in/sih2018/public/video/THANGA_THARAGAI.mp4"  type="video/mp4">
                  </video>
               </div>
               <div class="row" style="max-height:700px;width:100%">
                  <h4 style="margin-bottom: 0px;" >Transcripts:</h4>
      ...
      //time seeker
         ...
         //topics
             ...
             for (var iterator in topics) {
                node+='<div class="bg-primary topi" stime="'+topics[iterator][0]["startTime"]+'" style=" font-size: 14px; margin-left: 2%;margin-right: 2%;">&nbsp'+iterator+'&nbsp</div>'; 
         ...
         `);
             for (var iterator in face) {
                       node+=`<div> <img src="`+face[iterator]["thumbnailFullUrl"]+`"class="img-circle face"  stime="`+face[iterator]["appearances"][0]["startTime"]+`"alt="Cinque Terre" width="120" height="120"><p style="font-size:14px;">`+iterator+`</p></img></div>`;
          ...
          for (var i = 0; i < classnode.length; i++) {
             ...
             for (var iterator in anno) {
                       node+='<div class="bg-primary anno" stime="'+anno[iterator][0]["startTime"]+'" style=" font-size: 15px; margin-left: 2%;margin-right: 2%;">&nbsp'+iterator+'&nbsp</div>'; 
          ...
          for (var i = 0; i < classnode.length; i++) {
            ...
            var brands=JSON.parse(`{"Google":["http:\/\/en.wikipedia.org\/wiki\/Google","Google is an American multinational technology company specializing in Internet-related services and products. These include online advertising technologies, search, cloud computing, and software. Most of its profits are derived from AdWords, an online advertising service that places advertising near the list of search results.",[{"startTime":"00:05:30.5040000","endTime":"00:05:40.8240000","startSeconds":330.5,"endSeconds":340.8}]]}`);
             for (var iterator in brands) {
                       node+='<div class="bg-primary bran" stime="'+brands[iterator][2][0]["startTime"]+'" style=" font-size: 15px; margin-left: 2%;margin-right: 2%;">&nbsp'+iterator+'&nbsp</div>'; 
