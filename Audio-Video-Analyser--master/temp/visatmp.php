    ...
    padding-right: 0px;">
            <ul class="nav sidebar-nav">
                ...
                <li>
                    ...
                    <li><a href="compare_videos.php">Compare Videos</a></li>
            ...
            <div class="container" >
                     ...
                     <div class="row">
                         ...
                         // 
                           $conn=connection();
                            ...
                            $userid=8;
                            $sql="select * from data where userid={$userid} and type=1 ";
                            // echo $sql;
                                     ...
                                     <video src="http://www.trendsepc.in/sih2018/public/video/'.$row["name"].'" alt="User Video"></video>
                                        <form action="video_analysis.php" align="center" method="post">
                                          <input type="text" name="name" value="'.$row["dataid"].'" hidden/>
                                            <b><button class="btn btn-link" style="font-weight:bold;text-align:center;font-style:bold;text-decoration:none;color:white;" type="submit">'.$row["name"].'</button></b>
                                        </form>
                                        <button type="submit"  class="btn btn-link " > <span '; 
                                        
                                        if($row["favourite"]==1){echo 'style="color:gold;"';}
                                        else{echo 'style="color:gray;" ';} echo 'class="glyphicon glyphicon-star datak" dataid="'.$row["dataid"].'"> </span>
                ...
                <div id="identitycard"  class="mainbox col-md-12">
					...
					<div class="input-group image-preview">
						<input placeholder=""  style="color:white;font-weight:bold;background-color:#69706b;"type="text"  name="file_name" id="file_name" class="form-control image-preview-filename" disabled="disabled">
						<!-- don't give a name === doesn't send on POST/GET --> 
						<span class="input-group-btn"> 
						<!-- image-preview-clear button -->
						<button type="button" class="btn btn-default image-preview-clear" style="display:none;"> <span class="glyphicon glyphicon-remove" ></span> Clear </button>
						<!-- image-preview-input -->
						<div class="btn btn-danger image-preview-input"> <span class="glyphicon glyphicon-folder-open"></span> <span class="image-preview-input-title" style="color:white;"><b>Browse</b></span>
							<input type="file"  name="file1" id="file1" onchange="$('#file_name').val(this.value.split('\\')[2])"/>
							<!-- rename it --> 
						</div>
						
						<button  type="button" id="uploadbutton" class="btn btn-labeled btn-warning" onClick="uploadFile();"> <span class="btn-label"><i class="glyphicon glyphicon-upload"></i> </span><b  style="color:white;">Upload</b></button>
						</span> </div>
					...
					<br />
                                                    <button type="button" id="hov" class="btn btn-lg btn-block"  style="border-radius:50px;" onClick="upload_break()"><b>Analyze</b></button>
                            ...
                            <div class="panel panel-info" style="background-color:#d0efef;border-radius:10%;">
                                <div class="panel-heading" style="background-color:#757caf;">
                                    <div class="panel-title" style="color:white;"><center><b>Upload Your Video via link</b></center></div>
                                </div>
                                <div class="panel-body">
                                 
			
					<div class="input-group image-preview">
						<input placeholder="Enter or Paste your Link Here"  style="color:olive;font-weight:bold;background-color:white;"type="text"  name="file_url" id="file_nameurl" class="form-control image-preview-filename" >
						<!-- don't give a name === doesn't send on POST/GET--> 
						<span class="input-group-btn"> 
						<!-- image-preview-clear button--> 
						
						
						<button  type="button" id="uploadbuttonurl" class="btn btn-labeled btn-warning" onClick="uploadFileurl();"> <span class="btn-label"><i class="glyphicon glyphicon-upload"></i> </span><b  style="color:white;">Upload</b></button>
						</span> </div>
					...
					<h3 id="statusurl"></h3>
					<p id="loaded_n_totalurl"></p>
					<br />
                                                    <button type="button" id="hovurl" class="btn btn-lg btn-block"  style="border-radius:50px;" onClick="upload_breakurl()"><b>Analyze</b></button>
