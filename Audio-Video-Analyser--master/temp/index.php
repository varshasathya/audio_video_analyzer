        ...
        $.ajax({
         ...
         // dataType: 'json',
		  success: function(data) {
			  $('#loader_gif').modal('hide');
			  if(data == "")
			  {
				
           $('#mycheck_number').modal('toggle');
			  }
          else{
				...
				<div class="main-login main-center">
					...
					<form class="" method="post" action="#">
						...
						<div class="form-group " id="load">
							<button   target="_blank"  id="idea" data-dismiss="modal" onClick="testing_signup();" type="button"  class="btn btn-default btn-lg btn-block login-button">Sign Up</button>
						</div>
          ...
          <div class="row main">
				<div class="main-login main-center">
					...
					<form class="" method="post" action="#">
						...
						<br/>
						<div class="form-group " id="load">
							<button   target="_blank"  id="idea" data-dismiss="modal" onClick="testing_login();" type="button"  class="btn btn-default btn-lg btn-block login-button">Sign In</button>
						</div>
