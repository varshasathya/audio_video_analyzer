                           ...
                           //print_r($result);
                            while($row = mysqli_fetch_assoc($result)) {
                             ...
                             echo '<div class="col-sm-4">
                                 <div class="jumbotron" style="padding-top: 10px;padding-right: 0px;padding-left: 0px;padding-bottom: 0px;margin-bottom: 0px;text-align:center" >
                                     <video src="http://www.trendsepc.in/sih2018/public/video/'.$row["name"].'" alt="User Video"></video>
                                
                                            <button class="btn btn-link" style="text-align:center" type="button">'.$row["name"].'</button>
                                  </div></div>';
                                  if($c==3){
