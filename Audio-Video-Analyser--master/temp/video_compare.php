        ...
        <div id="page-content-wrapper">
            ...
            <div class="container" >
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                                <form action="compare_results.php" method="post" class="form-inline" onSubmit="return verify();" >
                                        <input type="text" class="form-control" name="video1" id="video1" value="" placeholder="Video 1" readonly/>
                                        <input type="text"  name="breakdown1" id="breakdown1" value="hello" hidden/>
                                         <input type="text" class="form-control" name="video2"  id="video2" value="" placeholder="Video 2" readonly/>
                     ...
                     <div class="row">
                         ...
                         // 
                           $conn=connection();
                            ...
                            $userid=8;
                            $sql="select * from data INNER join data_details ON data.dataid = data_details.dataid and data.dataid in (select dataid from data_details where processed_state = 1) and userid={$userid}";
                            // echo $sql;
                             ...
                             echo '<div class="col-sm-4">
                                 <div class="jumbotron" style="padding-top: 10px;padding-right: 0px;padding-left: 0px;padding-bottom: 0px;margin-bottom: 0px;" >
                                     <video src="http://www.trendsepc.in/sih2018/public/video/'.$row["name"].'" alt="User Video"></video>
                                           <form align="center"> <button class="btn btn-link" style="text-align:center;color:'.$row["breakdown_id"].'" value="'.$row["name"].'" id="'.$row["breakdown_id"].'" type="button" onclick="changelink(this);">'.$row["name"].'</button></form>
                                  </div></div>';
                                  if($c==3){
