...
<!------ Include the above in your HEAD tag ---------->
 ...
 <div class="navbar navbar-dark bg-primary" role="navigation" style="width:400px text-align:left">
    ...
    <div id="wrapper">
            ...
            <div class="container" >
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-11" style="background-color:#fdffc1">
                            ...
                            ?>
                                <div class="row" style="background-color:#949657">
                                <h3 style="color:#a8f6ff">The Common features in the videos are:</h3>
                                    <div class="col-md-6">
                           ...
                           //     print_r($rjson);
                               ...
                               // print_r($rjson);
                                ...
                                <div class="row pads" >
                  <h4>Faces matching:</h4>
                  <div class=" pads scrollmenu" id="faces"> </div>
               </div>
                                
                                <div class="row pads" >
                  <h4>Keywords:</h4>
                  <div class=" pads scrollmenu" id="title"> <div class="alert alert-warning">No match found </div></div>
               </div>
                                    <div class="row pads" >
                  <h4>Objects:</h4>
               ...
               <h4>Percentage of matching in keywords:</h4>
               <div class="progress">
      ...
      <h4>Percentage of matching in objects:</h4>
               <div class="progress">
      ...
      <h4>Percentage of matching in Topics:</h4>
               <div class="progress">
